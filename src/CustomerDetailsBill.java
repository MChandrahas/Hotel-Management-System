...
public class CustomerDetailsBill extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 100, -1, 30));
        ...
        getContentPane().add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 100, 220, 30));
        ...
        getContentPane().add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(810, 100, -1, 30));
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Name", "Mobile No", "Nationality", "Gender", "Email", "ID Proof", "Adress", "Check IN Date", "Room NO", "Bed", "Room Type", "Price Per Day", "Number of Days Stay", "Total Ammount", "Check Out Date"
            }
        ));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 160, 1180, 370));
        ...
        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/background1366x768_1.jpg"))); // NOI18N
